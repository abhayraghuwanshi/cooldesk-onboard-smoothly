...
const TermsPage = () => {
  return (
    <main className="min-h-screen text-white">
      <SEO
        title="Terms of Service — CoolDesk"
        description="The terms governing your use of the CoolDesk browser extension and services — license, user responsibilities, intellectual property, privacy and liability."
        canonical="https://cool-desk.com/terms"
      />
