...
export const features: Feature[] = [
    {
        ...
        desc: 'Every project gets its own workspace — browser tabs, saved links, notes, and files all in one place. Open everything with one click. Switch projects in seconds.',
    ...
    },
    {
        ...
        desc: 'One bar searches your entire OS and browser — open tabs, history, bookmarks, notes, and running apps.',
        gridClasses: 'md:col-span-1',
        bgClass: 'bg-blue-100',
    },
    {
        illustration: <IllustrationVoice />,
        title: 'Focus the right window, not just the right app',
        desc: '3 VS Code windows open? CoolDesk shows all 3 — each with its project name. Click to focus the exact one you need. Raycast and Spotlight just show "VS Code".',
        gridClasses: 'md:col-span-1',
        bgClass: 'bg-rose-100',
    },
    {
        illustration: <IllustrationThemes />,
        title: 'AI SmartWorkspace',
        desc: 'AI reads your browsing history, open tabs, and AI chat threads — then organizes everything into project groups automatically.',
        gridClasses: 'md:col-span-2',
        bgClass: 'bg-purple-100',
    },
    {
        illustration: <IllustrationNotes />,
        title: 'Notes & Voice Capture',
        desc: 'Quick-capture notes per project. Dictate by voice — no extra app needed.',
        gridClasses: 'md:col-span-1',
    ...
    },
    {
        ...
        desc: 'Auto-group tabs by domain, focus mode, task view, and activity-based sorting — keep only what matters visible.',
        gridClasses: 'md:col-span-1',
        bgClass: 'bg-cyan-100',
    },
    {
        illustration: <IllustrationPins />,
        title: 'Activity Feed & Pins',
        desc: 'Pinned links, recent AI chats from ChatGPT and Claude, and bookmarks — surfaced on your new tab every day.',
        gridClasses: 'md:col-span-2',
